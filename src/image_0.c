...
/*   Updated: 2023/08/02 11:52:48 by olivierbouc      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	norm1(t_img *m, int i)
{
	...
	if (i < 16)
	{
		...
		m->deep_dirt[i] = \
			mlx_texture_to_image(g()->mlx, g()->tex.deep_dirt[i]);
	...
	if (i < 20)
	{
		...
		m->wood_wall[i] = \
			mlx_texture_to_image(g()->mlx, g()->tex.wood_wall[i]);
		m->stone_wall[i] = \
			mlx_texture_to_image(g()->mlx, g()->tex.stone_wall[i]);
	}
}
...
void	init_img(t_img *img)
{
	...
	img->wood_floor[0] = \
		mlx_texture_to_image(g()->mlx, g()->tex.wood_floor[0]);
	img->stone_floor[0] = \
		mlx_texture_to_image(g()->mlx, g()->tex.stone_floor[0]);
