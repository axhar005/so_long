...
/*   Updated: 2023/07/23 10:48:42 by olivierbouc      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_all_texture(void)
{
	...
	{
		if (i < 4)
			g()->tex.crack[i] = mlx_load_png(ft_stringf("./asset/crack/crack_%d.png", i));
		if (i < 16)
		{
			g()->tex.grass[i] = mlx_load_png(ft_stringf("./asset/grass/grass_%d.png", i));
			g()->tex.sand[i] = mlx_load_png(ft_stringf("./asset/sand/sand_%d.png", i));
			g()->tex.water[i] = mlx_load_png(ft_stringf("./asset/water/water_%d.png", i));
			g()->tex.deep_dirt[i] = mlx_load_png(ft_stringf("./asset/deep_dirt/deep_dirt_%d.png", i));
		}
		g()->tex.hill[i] = mlx_load_png(ft_stringf("./asset/hill/hill_%d.png", i));
		g()->tex.wood_wall[i] = mlx_load_png(ft_stringf("./asset/wood/wood_wall/wood_wall_%d.png", i));
		g()->tex.stone_wall[i] = mlx_load_png(ft_stringf("./asset/stone/stone_wall/stone_wall_%d.png", i));
		i++;
	}
